...
(library Library_1
	...
	(compDef "TP4054-42-SOT25-R" (originalName "TP4054-42-SOT25-R") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "1" (pinName "__CHRG") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "GND") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "BAT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://images.100y.com.tw/pdf_file/38-TP-TP4054x.pdf")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "TP4054-42-SOT25-R.stp")
